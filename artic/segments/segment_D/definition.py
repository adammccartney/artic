...
fsmin7_42 = artic.tetrads['e_ii']
fsmin7 = artic.invert_up(fsmin7_42, 1)
fsmin7_6 = artic.invert_up(fsmin7_42, 2)
fsmin7_64 = artic.invert_up(fsmin7_42, 3)

fsm7_42 = artic.FuzzyHarmony('e_ii', fsmin7_42) # emin7
fsm7 = artic.FuzzyHarmony('e_ii', fsmin7_6) 
fsm7_6 = artic.FuzzyHarmony('e_ii', fsmin7_6)   
fsm7_64 = artic.FuzzyHarmony('e_ii', fsmin7_64)

gsd7_64 = artic.tetrads['cs_v']
gsd7_42 = artic.invert_up(gsd7_64, 1)
gsd7_mi2 = artic.invert_up(gsd7_64, 2)
gsd7_aug4 = artic.invert_up(gsd7_64, 3)

gs7_64 = artic.FuzzyHarmony('cs_v', gsd7_64)
gs7_42 = artic.FuzzyHarmony('cs_v', gsd7_42) 
gs7_mi2 = artic.FuzzyHarmony('cs_v', gsd7_mi2)   
gs7_aug4 = artic.FuzzyHarmony('cs_v', gsd7_aug4)
...
rhythm_definition.notes = [
        (sul_IV, abjad.Duration(1), artic.time_signature("4/4"), artic.tie()),
        (sul_IV, abjad.Duration(1), artic.tie()),
        (sul_IV, abjad.Duration(1), artic.tie()),
        (IV_fl_2, abjad.Duration(1), artic.harmonic_mixed_on()),
        #----------------Bar 5
        (fifth_fl_trem_IV),
        (IV_fl_3, abjad.Duration(1)),
        (third_fl_trem_IV),
        (IV_fl_3, abjad.Duration(1)),
        #----------------Bar 9
        (third_fl_trem_IV),
        (IV_fl_3, abjad.Duration(1)),
        (fifth_fl_trem_IV),
        (IV_fl_2, abjad.Duration(1)),
        #----------------Bar 13
        (sul_IV, abjad.Duration(1), artic.default_on(), artic.tie()),
        (sul_IV, abjad.Duration(1), artic.tie()),
        (sul_IV, abjad.Duration(1)),
        ("r1"),
        #----------------Bar 17
        ("r1"),
        ("r1"),
        (sul_II, abjad.Duration(1), artic.tie(), artic.default_on()),
        (sul_II, abjad.Duration(1), artic.tie(), artic.default_on()),
        #----------------Bar 21
        (sul_II, abjad.Duration(1), artic.tie(), artic.default_on()),
        (II_fl_2, abjad.Duration(1), artic.harmonic_mixed_on()),
        (fifth_fl_trem_II),
        (II_fl_3, abjad.Duration(1), artic.tie()),
        #----------------Bar 25
        (third_fl_trem_II),
        (II_fl_3, abjad.Duration(1)),
        (third_fl_trem_II),
        (II_fl_3, abjad.Duration(1)),
        #----------------Bar 29
        (fifth_fl_trem_II),
        (II_fl_2, abjad.Duration(1)),
        (sul_II, abjad.Duration(1), artic.tie(), artic.default_on()),
        (sul_II, abjad.Duration(1), artic.tie()),
        #----------------Bar 33
        (sul_II, abjad.Duration(1), artic.tie()),
        (sul_II, abjad.Duration(1), artic.tie()),
        (sul_II, abjad.Duration(1), artic.tie()),
        ...
        (sul_II, abjad.Duration(1), artic.tie()),
        (sul_II, abjad.Duration(1), artic.tie()),
        (sul_II, abjad.Duration(1)),
        #----------------Bar 41
        (empty_58_measure),
        ("r4"),
        (sul_III, abjad.Duration(3, 8), artic.staccato()),
        ("r4"),
        (I_fl_2, abjad.Duration(3, 8), artic.staccato(), 
                artic.harmonic_mixed_on()),
        ("r4"),
        (III_fl_3, abjad.Duration(3, 8), artic.staccato()),
        #----------------Bar 45
        ("r4"),
        (sul_I, abjad.Duration(3, 8), artic.staccato(), artic.default_on()),
        ("r4"),
        (III_fl_3, abjad.Duration(3, 8), artic.staccato(), 
                artic.harmonic_mixed_on()),
        ("r4"),
        ...
        ("r4"),
        (I_fl_3, abjad.Duration(3, 8), artic.staccato(), 
                artic.harmonic_mixed_on()),
        ("r4"),
        (I_fl_4, abjad.Duration(3, 8), artic.staccato(),
                artic.barline("||")),
   ]
...
rhythm_definition.markup = [
        ...
        (3, artic.markup.sul_IV(), 5.5),
        (22, artic.markup.flaut(), 1.5),
        (25, artic.markup.sul_II(), 2.5),
        (50, artic.markup.sul_III(), 2.5),
        (52, artic.markup.sul_I(), 4.5),
        (54, artic.markup.sul_III(), 5.5),
        (56, artic.markup.sul_I(), 2.5),
        (58, artic.markup.sul_III(), 4.5),
        (60, artic.markup.sul_I(), 4.5),
        (62, artic.markup.sul_III(), 6.5),
        (66, artic.markup.sul_I(), 7.5),
        ]
...
rhythm_definition.notes = [
        ...
        (diad_four, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (diad_four, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (diad_four, abjad.Duration(1, 2), artic.tremolo(32), artic.tie()),
        (vln_sul_IV_double, abjad.Duration(1, 2), artic.tremolo(32), artic.tie()),
        #----------------Bar 5
        (vln_sul_IV_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (vln_sul_IV_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (vln_sul_IV_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (vln_sul_IV_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        #----------------Bar 9
        ...
        (diad_four, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        ("r1"),
        (diad_two, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (diad_two, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        #----------------Bar 21
        (diad_two, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (diad_two, abjad.Duration(1, 2), artic.tremolo(32), artic.tie()),
        (vln_sul_II_double, abjad.Duration(1, 2), artic.tremolo(32), artic.tie()),
        (vln_sul_II_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (vln_sul_II_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        #----------------Bar 25
        (vln_sul_II_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
        (vln_sul_II_double, abjad.Duration(1), artic.tremolo(32), artic.tie()),
